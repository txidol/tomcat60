...
public class WebappSessionManager {
     ...
     */
    protected ServletContextImpl container;
     ...
     */
    public ServletContextImpl getContainer() {
     ...
     */
    public void setContainer(ServletContextImpl container) {

        ServletContextImpl oldContainer = this.container;
...
//        if( oname==null ) {
//            try {
//                ServletContextImpl ctx=(ServletContextImpl)this.getContainer();
...
//            log.debug("Registering " + oname );
     ...
     */
    protected HttpSessionImpl getNewSession() {
