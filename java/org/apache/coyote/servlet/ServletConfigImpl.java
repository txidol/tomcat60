 ...
 * @version $Revision: 345286 $ $Date: 2005-11-17 09:00:24 -0800 (Thu, 17 Nov 2005) $
 */
...
//                                   this.maxInstances);
    ...
    public void setParent(ServletContextImpl container) {
        ...
        swallowOutput = container.getSwallowOutput();
        unloadDelay = container.getUnloadDelay();
...
//                                   this.servletClass);
        // TODO(costin): how does this work for precompiled JspC ??
        if (JSP_SERVLET_CLASS.equals(servletClass)) {
            isJspServlet = true;
        }
    }
...
//        fireContainerEvent("unload", this);
    ...
    public ServletContext getServletContext() {
        ...
        if (parent == null)
            return (null);
        else if (!(parent instanceof ServletContextImpl))
            return (null);
        else
            return (((ServletContextImpl) parent).getServletContext());
