...
public class ServletResponseImpl
    ...
    public void setConnector() {
        ...
        outputBuffer = MessageWriter.getWriter( request.getCoyoteRequest(), coyoteResponse, 8196); 
     ...
     */
    protected ServletRequestImpl request = null;
    ...
    public void setRequest(ServletRequestImpl request) {
        this.request = (ServletRequestImpl) request;
        setConnector();
    }
...
//        } 
    ...
    protected boolean isEncodeable(final String location) {
        ...
        final ServletRequestImpl hreq = request;
        final HttpSessionImpl session = hreq.getSessionInternal(false);
        if (session == null)
            return (false);
    ...
    private boolean doIsEncodeable(ServletRequestImpl hreq, HttpSessionImpl session, 
                                   String location) {
